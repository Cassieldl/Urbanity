...
import {
  ...
  pieArcClasses,
  pieArcLabelClasses
} from "./chunk-NOXFLM5O.js";
import {
  SparkLineChart
} from "./chunk-CSWRT7AF.js";
import {
  AnimatedArea,
  AnimatedLine,
  AreaElement,
...
import {
  ...
  yellowPaletteDark,
  yellowPaletteLight
} from "./chunk-5EURIXI2.js";
import "./chunk-EUFGBM2B.js";
import {
  warnOnce
} from "./chunk-TTGKUZR6.js";
import "./chunk-KZBVX5LG.js";
import "./chunk-EFBFTVIM.js";
import "./chunk-5CE5QJJQ.js";
import {
  useSlotProps_default
} from "./chunk-HS6F3CGT.js";
import "./chunk-RQCRLO67.js";
import "./chunk-SLQHA7AI.js";
import "./chunk-FVZHPG4M.js";
import {
  useThemeProps
} from "./chunk-WGY6PBI6.js";
import "./chunk-PH7LCGO2.js";
import "./chunk-JXBLV77I.js";
import "./chunk-NP4IY7ZN.js";
import "./chunk-7FRSFGTA.js";
import "./chunk-2RJCFLIP.js";
import "./chunk-DZNSUR4I.js";
import "./chunk-LTBU7NBW.js";
import "./chunk-PYZEW55J.js";
import {
  _objectWithoutPropertiesLoose
} from "./chunk-BFL632LT.js";
import "./chunk-ITGWAFDM.js";
import "./chunk-ZCSSBJ3Q.js";
import "./chunk-JKWBV3HE.js";
import "./chunk-A7ECLLTJ.js";
import "./chunk-6QXI464Y.js";
import "./chunk-A6XQ4W7T.js";
import "./chunk-TWGKB2OS.js";
import "./chunk-NXD3Z2YP.js";
import "./chunk-3JOA4H7Q.js";
import "./chunk-N6CWVJBT.js";
import "./chunk-GOZHMSIK.js";
import "./chunk-M43GC5IE.js";
import "./chunk-IZT63NOV.js";
import {
  useId
} from "./chunk-XVMBJR5R.js";
import "./chunk-G6IMPONC.js";
import "./chunk-PIBZ5N2X.js";
import "./chunk-XQK2YVLV.js";
import "./chunk-FC7UQGM3.js";
import "./chunk-FZKIQLEM.js";
import {
  useForkRef
} from "./chunk-RII6YGDI.js";
import "./chunk-TZ2URKXQ.js";
import "./chunk-BS5OY5WE.js";
import "./chunk-ZV4QXYSH.js";
import "./chunk-37EV5VT2.js";
import {
  useTheme
} from "./chunk-WW47ZWTY.js";
import {
  clsx,
  clsx_default,
  composeClasses,
...
} from "./chunk-2AIAR7CR.js";
import "./chunk-UUEOK2OD.js";
import {
  require_prop_types
...
function Scatter(props) {
  ...
  const cleanData = React6.useMemo(() => {
  ...
  return (0, import_jsx_runtime5.jsx)("g", {
    ...
    children: cleanData.map((dataPoint, i) => (0, import_jsx_runtime5.jsx)(Marker, _extends({
      ...
      "data-highlighted": dataPoint.isHighlighted || void 0,
      "data-faded": dataPoint.isFaded || void 0
...
var ScatterChart = React9.forwardRef(function ScatterChart2(inProps, ref) {
  var _a, _b, _c, _d;
  ...
  return (0, import_jsx_runtime7.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime7.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime7.jsx)(Toolbar3, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime7.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime7.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
...
var GaugeContext = React10.createContext({
  value: null,
  valueMin: 0,
  valueMax: 0,
  startAngle: 0,
...
function useGaugeState() {
  return React10.useContext(GaugeContext);
}
...
var GaugeContainer = React11.forwardRef(function GaugeContainer2(props, ref) {
  const {
    width: inWidth,
    height: inHeight,
    margin,
...
var Gauge = React15.forwardRef(function Gauge2(props, ref) {
  const {
    text,
    children,
    className,
...
var _excluded8 = ["apiRef", "series", "radar", "width", "height", "margin", "colors", "sx", "children", "slots", "slotProps", "skipAnimation", "loading", "highlightedItem", "onHighlightChange", "hideLegend", "divisions", "shape", "stripeColor", "highlight", "showToolbar"];
...
function RadarGrid(props) {
  ...
  return shape === "sharp" ? (0, import_jsx_runtime18.jsxs)(React20.Fragment, {
  ...
  }) : (0, import_jsx_runtime18.jsxs)(React20.Fragment, {
...
function RadarDataProvider(props) {
  ...
  const rotationAxes = React21.useMemo(() => [{
  ...
  const radiusAxis = React21.useMemo(() => radar.metrics.map((m) => {
    const {
      name,
      min = 0,
      max = radar.max
  ...
  const defaultizedSeries = React21.useMemo(() => series.map((s) => _extends({
    type: "radar",
  ...
  const defaultizedMargin = React21.useMemo(() => defaultizeMargin(margin, DEFAULT_RADAR_MARGIN), [margin]);
...
true ? RadarSeriesArea.propTypes = {
   ...
   */
  seriesId: import_prop_types11.default.string
} : void 0;
...
var RadarChart = React27.forwardRef(function RadarChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiRadarChart"
  ...
  return (0, import_jsx_runtime25.jsx)(RadarDataProvider, _extends({}, radarDataProviderProps, {
    children: (0, import_jsx_runtime25.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime25.jsx)(Toolbar3, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime25.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime25.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        ref,
        children: [(0, import_jsx_runtime25.jsx)(RadarGrid, _extends({}, radarGrid)), (0, import_jsx_runtime25.jsx)(RadarMetricLabels, {}), (0, import_jsx_runtime25.jsx)(RadarSeriesArea, {}), highlight === "axis" && (0, import_jsx_runtime25.jsx)(RadarAxisHighlight, {}), (0, import_jsx_runtime25.jsx)(RadarSeriesMarks, {}), (0, import_jsx_runtime25.jsx)(ChartsOverlay, _extends({}, overlayProps)), children]
...
var ChartContainer = React28.forwardRef(function ChartContainer2(props, ref) {
  const {
    chartDataProviderProps,
    children,
    chartsSurfaceProps
  ...
  return (0, import_jsx_runtime26.jsx)(ChartDataProvider, _extends({}, chartDataProviderProps, {
    children: (0, import_jsx_runtime26.jsx)(ChartsSurface, _extends({}, chartsSurfaceProps, {
      children
    }))
  }));
});
...
true ? ChartContainer.propTypes = {
   ...
   * @param {null | ChartsAxisData} data The data about the clicked axis and items associated with it.
   */
  onAxisClick: import_prop_types16.default.func,
  /**
   * The callback fired when the highlighted item changes.
   *
   * @param {HighlightItemData | null} highlightedItem  The newly highlighted item.
   ...
   * An array of [[AxisConfig]] objects.
   */
  radiusAxis: import_prop_types16.default.arrayOf(import_prop_types16.default.shape({
    ...
    ignoreTooltip: import_prop_types16.default.bool,
    label: import_prop_types16.default.string,
    labelStyle: import_prop_types16.default.object,
    max: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number]),
    maxRadius: import_prop_types16.default.number,
    min: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number]),
    minRadius: import_prop_types16.default.number,
    offset: import_prop_types16.default.number,
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["linear"]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  rotationAxis: import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    barGapRatio: import_prop_types16.default.number,
    categoryGapRatio: import_prop_types16.default.number,
    classes: import_prop_types16.default.object,
    colorMap: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
      colors: import_prop_types16.default.arrayOf(import_prop_types16.default.string).isRequired,
    ...
    disableTicks: import_prop_types16.default.bool,
    domainLimit: import_prop_types16.default.oneOfType([import_prop_types16.default.oneOf(["nice", "strict"]), import_prop_types16.default.func]),
    endAngle: import_prop_types16.default.number,
    fill: import_prop_types16.default.string,
    height: import_prop_types16.default.number,
    hideTooltip: import_prop_types16.default.bool,
    id: import_prop_types16.default.oneOfType([import_prop_types16.default.number, import_prop_types16.default.string]).isRequired,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["band"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["point"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["log"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["pow"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["sqrt"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["time"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
    ...
    position: import_prop_types16.default.oneOf(["bottom", "none", "top"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["utc"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
    startAngle: import_prop_types16.default.number,
    stroke: import_prop_types16.default.string,
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axis: import_prop_types16.default.oneOf(["x"]),
    barGapRatio: import_prop_types16.default.number,
    categoryGapRatio: import_prop_types16.default.number,
    classes: import_prop_types16.default.object,
    colorMap: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    ...
    tickInterval: import_prop_types16.default.oneOfType([import_prop_types16.default.oneOf(["auto"]), import_prop_types16.default.array, import_prop_types16.default.func]),
    tickLabelInterval: import_prop_types16.default.oneOfType([import_prop_types16.default.oneOf(["auto"]), import_prop_types16.default.func]),
    tickLabelMinGap: import_prop_types16.default.number,
    tickLabelPlacement: import_prop_types16.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types16.default.object,
    tickMaxStep: import_prop_types16.default.number,
    tickMinStep: import_prop_types16.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types16.default.arrayOf(import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    axis: import_prop_types16.default.oneOf(["y"]),
    barGapRatio: import_prop_types16.default.number,
    categoryGapRatio: import_prop_types16.default.number,
    classes: import_prop_types16.default.object,
    colorMap: import_prop_types16.default.oneOfType([import_prop_types16.default.shape({
    ...
    min: import_prop_types16.default.oneOfType([import_prop_types16.default.instanceOf(Date), import_prop_types16.default.number]),
    offset: import_prop_types16.default.number,
    position: import_prop_types16.default.oneOf(["left", "none", "right"]),
    reverse: import_prop_types16.default.bool,
    scaleType: import_prop_types16.default.oneOf(["band"]),
    slotProps: import_prop_types16.default.object,
    slots: import_prop_types16.default.object,
...
var ToolbarContext = React29.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React29.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React29.useState(null);
  const focusableItemIdRef = React29.useRef(focusableItemId);
  const [items, setItems] = React29.useState([]);
  const getSortedItems = React29.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React29.useCallback((startIndex, step, wrap = true) => {
    var _a, _b;
  ...
  const registerItem = React29.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React29.useCallback((event) => {
    var _a;
    if (!focusableItemId) {
      return;
    }
  ...
  const onItemFocus = React29.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React29.useCallback((id) => {
    var _a;
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime27.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React30.useRef(disabled);
  React30.useEffect(() => {
  ...
  const previousAriaDisabled = React30.useRef(ariaDisabled);
  React30.useEffect(() => {
...
var Toolbar = React31.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime28.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
var ToolbarButton = React32.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render

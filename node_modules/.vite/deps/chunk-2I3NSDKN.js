...
var useChartPolarAxis = ({
  ...
  const svg2rotation = React11.useMemo(() => generateSvg2rotation({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const svg2polar = React11.useMemo(() => generateSvg2polar({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
  const polar2svg = React11.useMemo(() => generatePolar2svg({
    cx: center.cx,
    cy: center.cy
  }), [center.cx, center.cy]);
...
function useChartGradientIdBuilder() {
  ...
  return React12.useCallback((axisId) => `${chartId}-gradient-${axisId}`, [chartId]);
}
function useChartGradientIdObjectBoundBuilder() {
  const chartId = useChartId2();
  return React12.useCallback((axisId) => `${chartId}-gradient-${axisId}-object-bound`, [chartId]);
}
...
var ChartsLocalizationContext = React14.createContext(null);
...
function ChartsLocalizationProvider(inProps) {
  ...
  } = React14.useContext(ChartsLocalizationContext) ?? {
    localeText: void 0
  };
  ...
  const localeText = React14.useMemo(() => _extends({}, DEFAULT_LOCALE, themeLocaleText, parentLocaleText, inLocaleText), [themeLocaleText, parentLocaleText, inLocaleText]);
...
var useChartsLocalization = () => {
  const localization = React15.useContext(ChartsLocalizationContext);
...
//# sourceMappingURL=chunk-2I3NSDKN.js.map
